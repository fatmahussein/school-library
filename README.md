...
**[School Library]** School Library is a console app that allows users to: add new students or teachers, add new books, save records of who borrowed a given book and when. Built with Ruby.
